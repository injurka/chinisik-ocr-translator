...
- src/background/index.ts (6.60 KB)
...
- src/content-script/components/modules/translate-loading/ui/translate-loading.vue (3.10 KB)
...
- src/content-script/components/shared/hieroglyph-word/composables/use-inline-translation.ts (5.74 KB)
...
- src/content-script/components/shared/markdown-content/ui/markdown-content.vue (5.24 KB)
...
- src/content-script/overlay.vue (8.16 KB)
- src/manifest.json (1.42 KB)
...
- src/shared/api/services/all/providers/chinisik/provider.ts (7.91 KB)
- src/shared/api/services/all/translate-service.ts (6.17 KB)
- src/shared/api/services/all/types.ts (1.44 KB)
...
- src/shared/types/messaging.ts (1.50 KB)
